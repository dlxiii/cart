...
inputConf.base = [basedir,'cart/examples_box/mesh/box/'];
...
inputConf.river.flux = [basedir,'cart/examples_box/inp/river_flux.csv'];
inputConf.river.temp = [basedir,'cart/examples_box/inp/river_temp.csv'];
inputConf.river.salt = [basedir,'cart/examples_box/inp/river_salt.csv'];
inputConf.river.location = [basedir,'cart/examples_box/inp/river_location.csv'];
